/* Independent portfolio: English comes from HTML, Spanish from this dictionary. */
(() => {
  'use strict';
  const ES = {
  ...
  "proof.title": "Experiencia con equipos y negocios",
  "proof.experience": "LegalTech (voluntariado) · Coaching · Automatización de leads",
  "proof.credential": "DS4A · Data Analytics con honores",
  "proof.verify": "Ver credencial ↗",
  "approach.eyebrow": "Un punto de partida concreto",
  "approach.title": "¿Qué le está quitando<br>tiempo a tu equipo?",
  "approach.intro": "Tres formas de ayudarte. Partimos de un problema concreto y acordamos qué resultado necesitas.",
  "offer.data.pain": "Tu información está dispersa.",
  "offer.data.title": "Conectar tus datos",
  "offer.data.body": "Un flujo que conecta hojas de cálculo, bases de datos y herramientas de forma repetible.",
  "offer.disclosure": "Entregables y primer paso",
  "offer.data.item0": "Fuentes conectadas y datos consistentes",
  "offer.data.item1": "Actualización repetible y documentada",
  "offer.first": "Primer paso",
  "offer.data.first": "Revisamos tus fuentes y el reporte o proceso que las necesita.",
  "cta.data": "Hablemos de tus datos",
  "offer.dashboard.pain": "Cada reporte empieza de cero.",
  "offer.dashboard.title": "Un dashboard para tu equipo",
  "offer.dashboard.body": "Una vista clara de las métricas que necesita tu equipo, con el origen de cada cifra explicado.",
  "offer.dashboard.item0": "Un dashboard diseñado para tus preguntas",
  "offer.dashboard.item1": "Métricas y fuentes documentadas",
  "offer.dashboard.first": "Definimos las decisiones, las métricas y los datos que importan.",
  "cta.dashboard": "Hablemos de un dashboard",
  "offer.automation.pain": "La misma tarea, una y otra vez.",
  "offer.automation.title": "Automatizar una tarea recurrente",
  "offer.automation.body": "Un flujo para captar leads, actualizar información o trabajar con contenido, con IA donde aporte y revisión donde haga falta.",
  "offer.automation.item0": "Herramientas conectadas y pasos claros",
  "offer.automation.item1": "Revisión humana y manejo de excepciones",
  "offer.automation.first": "Mapeamos una tarea, sus herramientas y las personas involucradas.",
  "offer.automation.stack": "n8n · APIs · flujos con IA",
  "cta.automation": "Hablemos de una automatización",
  "delivery.title": "¿Qué pasa después de escribir?",
  "delivery.1.title": "Entender",
  "delivery.1.body": "Revisamos el proceso actual y qué está dificultando el trabajo.",
  "delivery.2.title": "Definir",
  "delivery.2.body": "Acordamos alcance, entregables y prioridades antes de construir.",
  "delivery.3.title": "Construir y probar",
  "delivery.3.body": "Probamos el flujo con tus datos y tu retroalimentación.",
  "delivery.4.title": "Entregar",
  "delivery.4.body": "Recibes el sistema, la documentación y una explicación de cómo usarlo.",
  "work.eyebrow": "Trabajo que puedes explorar",
  "work.title": "Del proceso<br>a la solución.",
  "work.intro": "Trabajo por proyecto, colaboración voluntaria y proyectos técnicos de ingeniería de datos e IA. Explora el alcance y mi aporte en cada uno.",
  "case.betterlife.type": "Por proyecto · 2024–2025",
  "case.betterlife.title": "Una primera versión de un producto financiero.",
  "case.problem": "Problema",
  "case.betterlife.problem": "Los clientes de coaching no tenían una forma sencilla de registrar ingresos y gastos ni de ver sus hábitos financieros.",
  "case.built": "Lo que construí",
  "case.betterlife.built": "Construí un MVP de finanzas personales con registros y reportes, y apoyé los procesos y la UX de la versión alfa.",
  "case.scope": "Alcance",
  "case.betterlife.scope": "MVP y versión alfa · colaboración por proyecto.",
  "case.betterlife.tools": "MVP · Reportes · Automatización de procesos",
  "case.jurisintel.type": "Voluntariado · 2025–2026",
  "case.jurisintel.title": "Facilitar el trabajo con documentos jurídicos.",
  "case.jurisintel.problem": "Los documentos jurídicos y las actualizaciones de casos necesitan organizarse para su revisión.",
  "case.jurisintel.built": "Contribuí con pipelines de NLP para documentos jurídicos, automatización del seguimiento de casos y apoyo a un chatbot jurídico con IA.",
  "case.jurisintel.scope": "Contribución voluntaria · pipelines, seguimiento y apoyo al chatbot.",
  "case.jurisintel.tools": "NLP · Seguimiento de casos · IA",
  "case.bilbao.type": "Por proyecto · enero de 2026",
  "case.bilbao.title": "De la captación al equipo adecuado.",
  "case.bilbao.problem": "Los leads entrantes necesitan calificarse y asignarse.",
  "case.bilbao.built": "Diseñé automatizaciones de captación, calificación y asignación de leads.",
  "case.bilbao.scope": "Colaboración por proyecto · diseño de automatizaciones.",
  "case.bilbao.tools": "n8n · Typeform · ActiveCampaign · CRM",
  "work.technical": "Proyectos técnicos · ingeniería de datos e IA",
  "geo.raw.number": "93,1 <small>GB</small>",
  "geo.data": "Imágenes originales de Sentinel-2",
  ...
  "geo.description": "Un proyecto universitario que conecta cinco fuentes de datos con un backend y un frontend explorable.",
  "geo.roleLabel": "Mi aporte · equipo de 3",
  "geo.role": "Ingeniería de datos, backend FastAPI, frontend React, pruebas y despliegue.",
  "geo.case": "Ver detalles <span aria-hidden=\"true\">+</span>",
  "geo.demo": "Ver aplicación <span aria-hidden=\"true\">↗</span>",
  "review.rating": "5/5 · 25 reseñas en Preply",
  "review.context": "Una reseña de mis clases en Preply",
  "review.quote": "«Desde la primera clase supo identificar lo que necesitaba y ver con claridad en qué me faltaba mejorar». <small>(traducción del inglés)</small>",
  "review.author": "Alice · Estudiante de español · abril de 2026",
  "review.link": "Leer las reseñas en Preply <span aria-hidden=\"true\">↗</span>",
  "about.eyebrow": "Sobre Sebastian",
  "about.title": "Construyo. Enseño.<br>Conecto ideas.",
  "about.lead": "Me gusta encontrarle sentido a lo complicado: ordenar datos, mejorar procesos y explicar cómo funciona lo que construyo.",
  "about.body": "Estoy terminando Ingeniería de Datos e IA en la Universidad Autónoma de Occidente. Construyo pipelines de datos, dashboards y flujos de automatización, y aplico IA a problemas concretos.",
  ...
  "about.projects.number": "3",
  "about.projects": "proyectos reales",
  "about.projects.scope": "Por proyecto y voluntariado",
  ...
  "contact.title": "Cuéntame qué te está<br>quitando tiempo.",
  "contact.body": "No necesitas una solución técnica definida. Un correo corto con estos tres puntos basta para empezar.",
  "contact.next.title": "Un primer paso claro",
  "contact.next.body": "Podemos revisar tu proceso actual, identificar un siguiente paso útil y acordar el alcance antes de construir.",
  "contact.copy": "Copiar correo",
  "contact.include.title": "Qué incluir en tu correo",
  "contact.include.help": "En qué necesitas ayuda.",
  "contact.include.process": "Cómo lo haces hoy y con qué herramientas.",
  "contact.include.result": "Qué resultado te sería útil.",
  "contact.linkedin": "¿Prefieres LinkedIn? Escríbeme por ahí ↗",
  "edu.languages": "Idiomas: español (nativo) · inglés (C2) · alemán (A2) · portugués (A2)",
  "proof.github.profile": "SEBASBELMOS en GitHub ↗",
  "contact.roles": "¿Buscas talento para tu equipo? <a href=\"assets/SEBASTIAN_BELALCAZAR_MOSQUERA.pdf\" download>Descarga mi CV</a>.",
  "footer.note": "© 2026 Sebastian Belalcazar",
  "dialog.label": "Detrás del proyecto",
  "edu.degree": "Ingeniería de Datos e IA",
  ...
  const ui = {
    en:{problem:'The problem',built:'What I built',evidence:'Scope & evidence',evidenceLabel:'Evidence & context',code:'View code',demo:'Open live app',details:'Project details',copied:'Email copied',copyFail:'Select the address and copy it',live:'Explore the live app ↗',more:'View all projects',less:'Show fewer projects',count:(n,t)=>`${n} of ${t} projects shown`,
      category:{data:'Data engineering',ai:'AI & products',bi:'Data visualisation',ml:'Applied ML',api:'Backend & APIs'},
    ...
    es:{problem:'El problema',built:'Lo que construí',evidence:'Alcance y evidencia',evidenceLabel:'Evidencia y contexto',code:'Ver código',demo:'Ver aplicación',details:'Ver detalles',copied:'Correo copiado',copyFail:'Selecciona la dirección y cópiala',live:'Explorar la aplicación ↗',more:'Ver todos los proyectos',less:'Mostrar menos proyectos',count:(n,t)=>`Mostrando ${n} de ${t} proyectos`,
      category:{data:'Ingeniería de datos',ai:'IA y productos',bi:'Visualización de datos',ml:'ML aplicado',api:'Backend y APIs'},
  ...
  const projects = [
    {id:'lakehouse',name:'NYC Taxi Lakehouse',category:'data',type:'data',status:'code',tech:['MinIO','Apache Iceberg','ClickHouse','dlt'],repo:'https://github.com/SEBASBELMOS/nyc-taxi-lakehouse',
      en:{summary:'NYC taxi trips, taken from a public source into a data lake and made queryable on several platforms.',problem:'Large public datasets have to be loaded, stored and checked in a repeatable way before anyone can query them with confidence.',built:'A university project I built end to end: a lakehouse pipeline that downloads the NYC Yellow Taxi data, stores it as Parquet in MinIO, registers Apache Iceberg tables in a Nessie catalogue and distributes them to Azure ADLS and ClickHouse with dlt, processing in PyArrow batches.',evidence:['Individual university project.','3,475,226 rows validated across the pipeline stages.','A verification script for each stage; runs locally with Docker Compose.']},
      es:{summary:'Viajes de taxi de Nueva York, desde una fuente pública hasta un data lake consultable en varias plataformas.',problem:'Los datasets públicos grandes deben cargarse, almacenarse y verificarse de forma repetible antes de consultarlos con confianza.',built:'Proyecto universitario que construí de principio a fin: un pipeline lakehouse que descarga los datos de NYC Yellow Taxi, los guarda en Parquet en MinIO, registra tablas Apache Iceberg en un catálogo Nessie y los distribuye a Azure ADLS y ClickHouse con dlt, procesando por lotes con PyArrow.',evidence:['Proyecto universitario individual.','3.475.226 filas validadas entre las etapas del pipeline.','Un script de verificación por etapa; se ejecuta en local con Docker Compose.']}},
    {id:'saludred',name:'SaludRed',category:'ai',type:'api',status:'code',tech:['FastAPI','PostgreSQL','HL7 FHIR R4','Docker'],repo:'https://github.com/SEBASBELMOS/saludred',
      en:{summary:'One shared view to coordinate hospital beds, requests and availability across a care network.',problem:'When capacity, requests and assignments live in separate places, teams duplicate work and lose track of who changed what.',built:'A university project I built end to end: a FastAPI and PostgreSQL system for coordinating beds across an EPS/IPS network, with role-based access, change history, an HL7 FHIR R4 integration and a web interface connected to the API.',evidence:['Individual university project with synthetic data only.','Flow: check capacity → create a request → assign a bed → review the history.','Role-based access; not a system in clinical use.']},
      es:{summary:'Una vista compartida para coordinar camas, solicitudes y disponibilidad en una red de salud.',problem:'Cuando la capacidad, las solicitudes y las asignaciones están en lugares distintos, los equipos duplican trabajo y pierden el rastro de los cambios.',built:'Proyecto universitario que construí de principio a fin: un sistema en FastAPI y PostgreSQL para coordinar camas en una red EPS/IPS, con acceso por roles, historial de cambios, integración HL7 FHIR R4 y una interfaz web conectada a la API.',evidence:['Proyecto universitario individual, solo con datos sintéticos.','Flujo: consultar capacidad → crear una solicitud → asignar una cama → revisar el historial.','Acceso por roles; no es un sistema en uso clínico.']}},
  ...
  function visual(id) {
    ...
    const art = {
      ...
      saludred:`<div class="mini-beds"><div class="beds-grid">${[1,0,1,1,0,1,0,0,1,0,1,0].map(f=>`<i class="${f?'filled':''}"></i>`).join('')}</div><p>${es?'Capacidad · Solicitudes · Asignación':'Capacity · Requests · Assignment'}</p></div>`,
  ...
  function setLanguage(next) {
    ...
    translatable.forEach(el => { el.innerHTML = dictionary[el.dataset.t]; });
    document.querySelectorAll('[data-label]').forEach(el => el.setAttribute('aria-label',labels[lang][el.dataset.label]));
    $('#language').setAttribute('aria-label',lang==='en'?'Cambiar a español':'Switch to English');
    document.querySelectorAll('[data-language]').forEach(el=>el.classList.toggle('selected',el.dataset.language===lang));
  ...
  const toggle=$('#menu-toggle'),navigation=$('#navigation');
  function closeMenu(){navigation.classList.remove('open');toggle.setAttribute('aria-expanded','false');toggle.setAttribute('aria-label',labels[lang]['menu.open']);}
  toggle.addEventListener('click',()=>{const open=toggle.getAttribute('aria-expanded')!=='true';toggle.setAttribute('aria-expanded',String(open));navigation.classList.toggle('open',open);toggle.setAttribute('aria-label',labels[lang][open?'menu.close':'menu.open']);});
  navigation.addEventListener('click',event=>{const link=event.target.closest('a');if(!link)return;const open=toggle.getAttribute('aria-expanded')==='true';closeMenu();if(open){const destination=document.querySelector(link.hash);destination?.setAttribute('tabindex','-1');destination?.focus({preventScroll:true});}});
  ...
  $('#copy-email').addEventListener('click',async()=>{
    const address=$('#project-email'),status=$('#copy-status');
    status.textContent='';
    try {
      await navigator.clipboard.writeText(address.textContent.trim());
      status.textContent=ui[lang].copied;
      document.dispatchEvent(new Event('portfolio:copy-email'));
    } catch {
      const range=document.createRange();
      range.selectNodeContents(address);
      const selection=window.getSelection();
      selection.removeAllRanges();selection.addRange(range);
      status.textContent=ui[lang].copyFail;
    }
  });
  // Native disclosures remain usable with JavaScript disabled.
  const mobile=matchMedia('(max-width: 640px)');
  const syncOffers=()=>document.querySelectorAll('.offer-details').forEach(el=>{el.open=!mobile.matches;});
  syncOffers();mobile.addEventListener('change',syncOffers);
  // Keep honest selected-work evidence visible if the optional image cannot load.
  if(window.PORTFOLIO_CONFIG?.HERO_DASHBOARD){
    const image=$('#hero-dashboard-image');
